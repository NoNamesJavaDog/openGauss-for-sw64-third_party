...
#  description: the script that make oracle_fdw
#  date: 2022-01-27
#  version: 1.0
#  history:
...
SOURCE_FILE=oracle_fdw-ORACLE_FDW_2_2_0.tar.gz
SOURCE_DIR=oracle_fdw-ORACLE_FDW_2_2_0
...
ROOT_DIR="${LOCAL_DIR}/../../"
TARGET_PATH=${ROOT_DIR}/output/kernel/dependency/oracle_fdw
...
patch -p0 -d ${SOURCE_DIR} < opengauss_oracle_fdw-2.2.0_patch.patch
...
cd ${SOURCE_DIR}
patch -p1 < ../opengauss_oracle_fdw-2.2.0_patch_20221230.patch
