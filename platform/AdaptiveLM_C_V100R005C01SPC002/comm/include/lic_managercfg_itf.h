...
* @datastruct ulResMinmVal Specifies Resource item minimal value which will
*  taken when this item not appear in the license, only for LIC_RESOURCE_CONTROL. 
* @datastruct ulResMaxVal Specifies Resource item maximal value which will
...
* @datastruct pacProdSecData Specifies decrypt key value which used to verify
*  license file.
*/
typedef struct TAG_LIC_BASIC_DATA_STRU
 {
...
*    separated by ','. It is suggested to fill it with only one ESN.\n
...
/*****************************************************************************
  ...
  Description  : Interface to set the flag for ban esn mismatch repeat activated.
