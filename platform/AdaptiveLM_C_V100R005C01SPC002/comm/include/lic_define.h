...
typedef enum TAG_LIC_LK_ITEM_STATE_ENUM
{
    ...
    LIC_ITEMS_NORMAL_STATE,       /* After LK activated, items becomes normal*/
...
*  LIC_ALARM_RSN_LK_ESN_MISMATCH ESN mismatch occurred while activating LK
*  LIC_ALARM_RSN_LK_VERSION_MISMATCH Version mismatch occurred while activating LK
...
typedef enum TAG_LIC_ALARM_REASON_ENUM
{
    ...
    /* ESN mismatch occurred while activating LK */
    LIC_ALARM_RSN_LK_ESN_MISMATCH = 4,

    /* Version mismatch occurred while activating LK */
    LIC_ALARM_RSN_LK_VERSION_MISMATCH = 5,

    /* Both ESN and Version mismatch occurred while activating LK */
...
{
    /* Absolute Timer. Deprecated. Not used */
...
*   Insufficient memory for safe memory
...
* state
*  LIC_ALARM_LK_DEFAULT This alarm specifies that NE is in default
* state
