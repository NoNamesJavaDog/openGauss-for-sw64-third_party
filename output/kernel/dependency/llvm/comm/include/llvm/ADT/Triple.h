...
public:
  enum ArchType {
    ...
    sw_64,          // ZENGZH20200814 SWLLVM sw64:basic Arch for SW
  ...
  enum VendorType {
    ...
    MipsTechnologies,
    Sw64Technologies,              //ZENGZH20200814 SWLLVM
    NVIDIA,
    CSR,
    Myriad,
    AMD,
...
#ifndef ZENGZH20200814_SWLLVM
  /// Tests whether the target is SW64 64-bit (little endian).
  bool isSw64() const {
    return getArch() == Triple::sw_64 ;
  }

  /// Tests whether the target is SW6a 64-bit (little endian).

  bool isSw6a() const {
    return getSubArch() == Triple::sw_6a;
  }

  bool isSw6b() const {
    return getSubArch() == Triple::sw_6b;
  }

  bool isSw4d() const {
    return getSubArch() == Triple::sw_4d;
  }

#ifndef BAOYL20220720_8A
  bool isSw8a() const {
    return getSubArch() == Triple::sw_8a;
  }
#endif

  /// Tests whether the target is SW (little endian, 64-bit).
  bool isSW() const {
